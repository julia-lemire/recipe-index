...
/**
 * Home Screen - Landing page showing this week's meal plans and recipe suggestions
 *
 * Layout:
        ...
        item {
            Card(
                ...
                Column(
                    ...
                    Text(
                        text = "We'll show you recipe ideas based on your favorites and seasonal ingredients",
                        style = MaterialTheme.typography.bodyMedium,
                        color = MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = 0.7f)
                    )
                }
