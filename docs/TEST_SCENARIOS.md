...
- [ ] Extract serving size from nutrition.servingSize field (planned - SchemaOrgRecipeParser.parseServingSize)
...
- [ ] joinInstructionLines detects "1." numbered steps (planned - digit + period delimiter)
- [ ] joinInstructionLines detects "1)" numbered steps (planned - digit + parenthesis delimiter)
- [ ] joinInstructionLines detects "1:" numbered steps (planned - digit + colon delimiter)
- [ ] joinInstructionLines detects "1 " numbered steps (planned - digit + space delimiter)
- [ ] joinInstructionLines joins non-numbered continuation lines (planned - lines not starting with digit+delimiter)
